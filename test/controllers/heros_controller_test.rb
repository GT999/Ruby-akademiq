...
class HerosControllerTest < ActionController::TestCase
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post :create, hero: { game_id: @hero.game_id, name: @hero.name, password: @hero.password, password_confirmation: @hero.password_confirmation }
    end
  ...
  test "should update hero" do
    patch :update, id: @hero, hero: { game_id: @hero.game_id, name: @hero.name, password: @hero.password, password_confirmation: @hero.password_confirmation }
    assert_redirected_to hero_path(assigns(:hero))
  end
